...
public class TestActivity extends AppCompatActivity
{
    ...
    // include된 ReviewActivity를 저장할 뷰 객체
    View included_view;
    // include된 뷰를 VISIBLE로 바꾸면 GONE으로 바꿔야 하는 레이아웃
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        init();
        included_view.setVisibility(View.GONE);
        ...
        favorite_btn.setOnLikeListener(new OnLikeListener()
        {
            ...
            public void liked(LikeButton likeButton)
            {
                ...
                Toast.makeText(TestActivity.this, message + " 정책을 내 관심사로 설정했습니다", Toast.LENGTH_SHORT).show();
            ...
            public void unLiked(LikeButton likeButton)
            {
                ...
                String message = detail_title.getText().toString();
                Toast.makeText(TestActivity.this, message + " 정책을 내 관심사에서 설정 해제했습니다", Toast.LENGTH_SHORT).show();
...
//					Log.e(TAG, "onResponse 성공 : " + response.body());
    ...
    private void init()
    {
        ...
        included_view = findViewById(R.id.review_include);
    ...
    protected void onResume()
    {
        ...
        detail_logo.setOnClickListener(new OnSingleClickListener()
        {
            ...
            {
                Intent d_intent = new Intent(TestActivity.this, MainTabLayoutActivity.class);
        ...
        review_view.setOnClickListener(new OnSingleClickListener()
        {
            ...
            public void onSingleClick(View v)
            {
                ...
                content_bottom_view.setVisibility(View.GONE);
                apply_bottom_view.setVisibility(View.GONE);
                included_view.setVisibility(View.VISIBLE);
            }
        });
...
//            String isBookmark;
        ...
        Log.e(TAG, "name : " + name + ", target : " + target + ", contents = " + contents + ", period = " + period + ", contact : " + contact + ", isBookmark = " + isBookmark +
                ", benefit_no : " + benefit_no + ", welf_apply = " + welf_apply);
    }

...
public class MapActivity extends AppCompatActivity
{
    ...
    Button jeonnam_benefit_btn, seoul_benefit_btn, incheon_benefit_btn, gyongi_benefit_btn, gangwon_benefit_btn, choongnam_benefit_btn, jeonbuk_benefit_btn,
            choongbuk_benefit_btn, jeju_benefit_btn, gyongbuk_benefit_btn, gyongnam_benefit_btn, all_district_btn, ulsan_benefit_btn, busan_benefit_btn,
            daejeon_benefit_btn, sejong_benefit_btn, gwangju_benefit_btn, daegu_benefit_btn;
...
//                Log.e(TAG, "local = " + get_area + ", welf_count = " + count_of_benefit);
    ...
    private void btnClickListener()
    {
        ...
        // 전국
        all_district_btn.setOnClickListener(OnSingleClickListener -> {
            Intent intent = new Intent(MapActivity.this, MapDetailActivity.class);
            intent.putExtra("area", "전국");
            intent.putExtra("welf_count", String.valueOf(count_list.get(0)));
            startActivity(intent);
        });
    ...
    private void init()
    {
        ...
        all_district_btn = findViewById(R.id.all_district_btn);
